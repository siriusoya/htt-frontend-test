    ...
    <div className="login_container">
      <div className="login_modal">
        ...
        <form id="login_form" onSubmit={handleSubmit(onSubmit)}>
          ...
          />
          {errors.email && errors.email.type === "required" && <p className="error_message">Email wajib diisi</p>}
          {errors.email && errors.email.type === "pattern" && <p className="error_message">Email tidak valid</p>}
          </div>
          ...
          />
          {errors.password && (
            <p className="error_message">Password wajib diisi</p>
          )}
          </div>
